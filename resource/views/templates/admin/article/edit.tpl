...
<div class="formbody">
    ...
    <div class="formtitle"><span>链接修改</span></div>
    <form name="myform" method="post">
        <input type="hidden" name="originator" value="838411">
        ...
        <ul class="forminfo">
            ...
            <li><label>内容标题<b>*</b></label><input name="title" type="text" class="dfinput" id="title"
                ...
                <i style="position:relative;"><img src="/images/article/colour.png" width="10" height="10"
                    ...
                    <img src="../images/bold.png" width="10" height="10" onclick="input_font_bold()"
                         style="cursor:hand"></i>
            ...
            <li><label>自动获取<b> </b></label><input name="add_introduce" type="checkbox" value="1" checked="">是否截取内容<input
                        ...
                        value="200">字符至内容摘要&nbsp;&nbsp; <input type="checkbox" name="auto_thumb" value="1">是否获取内容第<input
                        name="auto_thumb_no" type="text" class="dfinput" id="auto_thumb_no" style="width:30px;"
                        value="1">张图片作为标题图片
            </li>
            ...
            <li><label>推 荐 位<b> </b></label><cite>
                    ...
                    头条要闻 &nbsp;&nbsp;
                    <input name="posids[]" type="checkbox" id="posids" value="1">
                    首页幻灯 &nbsp;&nbsp;
                </cite>
            </li>
            <li><label>是否发布</label><cite><input name="status" type="radio" value="99" {if $article.status == 99} checked="checked" {/if}>是&nbsp;&nbsp;&nbsp;&nbsp;<input
                            name="status" type="radio" value="0" {if $article.status != 99} checked="checked"{/if}>否</cite></li>
        ...
        <textarea name="content" id="ueditor_textarea_content" style="display: none;"></textarea></form>
...
<div id="global-zeroclipboard-html-bridge" class="global-zeroclipboard-container"
    ...
    <object id="global-zeroclipboard-flash-bridge" name="global-zeroclipboard-flash-bridge" width="100%" height="100%"
            ...
            data="/other/ueditor/third-party/zeroclipboard/ZeroClipboard.swf?noCache=1477972903406">
