...
class WxPayConf_pub
{
    ...
    // Set
	const APPID = 'wx6425003a5beb48be';
	//受理商ID，身份标识
	const MCHID = '1322583501';
	//商户支付密钥Key。审核通过后，在微信发送的邮件中查看
	const KEY = '24JD5j3L1xmwQ5v0MUw2K1ppXEL1riDs';
	//JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
    // Set
	const APPSECRET = '584a1abb3bb7a9eb4a35634045dd5a8b';
...
//	const JS_API_CALL_URL = 'http://www.xxxxxx.com/demo/js_api_call.php';
	...
	const NOTIFY_URL = 'http://www.dianfengcms.com/wxpay/wxpay/notify';
