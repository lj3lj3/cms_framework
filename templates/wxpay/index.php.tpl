...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" type="text/css" href="/css/temp/wxpay/wxpay.css" media="screen"/>
    <script src="/js/jquery.js"></script>
    <script src="/js/temp/liveInterval.js"></script>
    <link rel="stylesheet" type="text/css" href="/css/temp/live.css">


    {literal}
    <style type="text/css">
        .post-qq-face{width:100%;height:100%;text-align:center;overflow-y:scroll}.post-qq-face span{width:14.28%;padding:5px 0;text-align:center}.post-qq-face span a{display:inline-block}.qqface-img{background:url(/images/qqface.jpg) no-repeat left top;background-size:100%;width:29px;height:29px}
    </style>
    {/literal}
</head>
<body class="nobottom qqfaceBottom">
<div class="text_input_box">

    <span class="boxFlex" style="border-bottom: 1px solid #e5e5e5;height:3.9rem;">
            <textarea class="speakInput" placeholder="来说点什么吧..."
                      onfocus="if(this.getAttribute('placeholder')=='来说点什么吧...')this.setAttribute('placeholder','')"
                      onblur="if(this.getAttribute('placeholder')=='')this.setAttribute('placeholder','来说点什么吧...')"></textarea>
            <span class="btnQQface"></span>
        </span>
    <i class="btnLiveTalk" onmousedown="return false" style="display: block;">发送</i>
</div>
<div id="div-qqfaces">
    <!--qq表情-->
    ...
    <span class="fl">
        ...
        <span class="fl">
        <a href="javascript:;" class="qqface-img" title="糗大了" code="[糗大了]"
           style="background-position: left -1247px;"></a>
    </span>
        <span class="fl">
        <a href="javascript:;" class="qqface-img" title="坏笑" code="[坏笑]" style="background-position: left -1276px;"></a>
    </span>
        <span class="fl">
        <a href="javascript:;" class="qqface-img" title="左哼哼" code="[左哼哼]"
           style="background-position: left -1305px;"></a>
    </span>
        <span class="fl">
        <a href="javascript:;" class="qqface-img" title="右哼哼" code="[右哼哼]"
           style="background-position: left -1334px;"></a>
    </span>
        <span class="fl">
        ...
        <span class="fl">
        <a href="javascript:;" class="qqface-img" title="快哭了" code="[快哭了]"
           style="background-position: left -1450px;"></a>
    </span>
        <span class="fl">
...
<a href="http://192.168.1.17:8888/wxpay/wxpay/dashang">打赏</a></li>
</body>
</HTML>
